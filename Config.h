...
#define SERIAL_B_BAUD_DEFAULT      230400  //   9600, n. See (src/HAL/) for your MCU Serial port # etc.                        Option
...
#define LIMIT_SENSE_STATE            HIGH //    LOW, For NO (normally open) switches, HIGH for NC (normally closed.)          Adjust
...
#define AXIS2_DRIVER_MICROSTEPS       256 //    OFF, n. Microstep mode when tra cking.                                        <-Often
